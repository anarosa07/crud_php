...
<link rel="stylesheet" href="css/estiloin.css">
  ...
  <nav class="navbar navbar-dark bg-dark">
      <div class="container">
        <a class="navbar-brand" href="index.php">FARMACIA PROFARMA</a>
...
?>
        ...
        <form class="d-flex" action="busqueda.php" method="GET">
            ...
            <button class="btn btn-outline-success" type="submit" name="enviar">
      <font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Búsqueda</font></font></button>
          </form>
          <?php
